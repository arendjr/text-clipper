...
Deno.test("html: test strip tags", () => {
    ...
    const htmlWithSvg = getHtmlWithSvg();
...
Deno.test("html: disable indicator at line break", () => {
    const options = { html: true, insertIndicatorAtLinebreak: false };

    assertEquals(clip("Lorum\nipsum", 10, options), "Lorum");
    assertEquals(clip("Lorum\nipsum", 100, { ...options, maxLines: 1 }), "Lorum");

    assertEquals(clip("Lorum<br/>ipsum", 100, { ...options, maxLines: 1 }), "Lorum");
    assertEquals(clip("Lorum\n\nipsum", 100, { ...options, maxLines: 2 }), "Lorum");

    assertEquals(clip("<p>&</p>", 1, options), "");
    assertEquals(clip("<p>&lt;</p>", 1, options), "");

    assertEquals(
        clip("<p>Lorem ipsum</p><p>Lorem ipsum</p>", 100, { ...options, maxLines: 1 }),
        "<p>Lorem ipsum</p>",
    );
    ...
    assertEquals(
        clip(getHtmlTable(), 26, { ...options, breakWords: true }),
        `<table border="1" cellpadding="1" cellspacing="1" style="width: 500px">
    <tbody>
        <tr>
            <td>fb</td>
    ...
    assertEquals(clip(getHtmlWithSvg(), 4, { ...options, stripTags: ["svg"] }), "<p>test</p>");
});
...
function getHtmlWithSvg(): string {
    return (
        "<p>" +
        '<svg width="100%" height="100%" viewBox="0 0 100 100"' +
        ' xmlns="http://www.w3.org/2000/svg">\n' +
