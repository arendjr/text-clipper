...
tape("html: test word breaking without indicator", function(test) {
    test.plan(7);
...
tape("html: test max lines", function(test) {
    ...
    test.equal(
        clip("<p>Lorem ipsum</p><p>Lorem ipsum</p>", 100, { html: true, maxLines: 2 }),
        "<p>Lorem ipsum</p><p>Lorem ipsum</p>",
    );
    test.equal(
        clip("<p>Lorem ipsum</p><p>Lorem ipsum</p>", 100, { html: true, maxLines: 1 }),
        "<p>Lorem ipsum</p>",
    );
    test.equal(
